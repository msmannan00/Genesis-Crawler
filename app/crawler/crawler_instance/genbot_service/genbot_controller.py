...
from crawler.crawler_instance.genbot_service.genbot_enums import ICRAWL_CONTROLLER_COMMANDS, CRAWL_HOST_LOCKS
...
class genbot_controller(request_handler):
    ...
    def __get_lock(self, p_letter):
        one_based = ord(p_letter) - 97
        if one_based < 0 or one_based > 27:
            one_based = 0
        return CRAWL_HOST_LOCKS[one_based]
...
def genbot_instance(p_url, p_vid):
    p_url = "http://loliporns5lm2t3lvojm6k7jjhduhpsty43g7izoerx475jtuticpiqd.onion/"
