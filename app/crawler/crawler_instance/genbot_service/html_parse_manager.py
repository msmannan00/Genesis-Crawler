...
class html_parse_manager(HTMLParser, ABC):
    ...
    def parse_html_files(self):
        ...
        m_validity_score = custom_filter_controller.get_instance().validate_custom_html_filter(self.m_base_url, self.m_raw_html, m_validity_score)
