...
class parse_controller:
    ...
    def on_parse_files(self, p_parsed_model: index_model, p_images, p_local_parser=False):
        m_images, m_documents, m_videos, m_content_type = self.__on_static_parser_invoke(p_images, p_parsed_model. m_document, p_parsed_model. m_video, p_parsed_model.m_content_type[0], p_local_parser, p_parsed_model.m_base_model)
    ...
    def __on_static_parser_invoke(self, p_images, p_documents, p_videos, p_content_type, p_local_parser, p_request_model: url_model):
        return self.m_static_parser.parse_static_files(p_images, p_documents, p_videos, p_content_type, p_local_parser, p_request_model)
