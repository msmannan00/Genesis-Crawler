...
def index_model_init(p_base_model, p_title, p_meta_description, p_title_hidden, p_important_content, p_important_content_hidden, p_meta_keywords, p_content, p_content_type, p_sub_url, p_document, p_video, p_validity_score):
    return index_model(**{'m_base_model': p_base_model, "m_title": p_title, "m_meta_description": p_meta_description, "m_title_hidden": p_title_hidden, "m_important_content": p_important_content, "m_important_content_hidden": p_important_content_hidden, "m_meta_keywords": p_meta_keywords, "m_content": p_content, "m_content_type": p_content_type, "m_sub_url": p_sub_url, "m_document": p_document, "m_video": p_video, "m_validity_score": p_validity_score})


def index_image_model_init(p_base_model, p_title, p_meta_description, p_title_hidden, p_important_content, p_important_content_hidden, p_meta_keywords, p_content, p_content_type, p_sub_url, p_images, p_document, p_video, p_validity_score):
