...
from crawler.crawler_services.crawler_services.topic_manager.topic_classifier_enums import TOPIC_CLASSFIER_TRAINER
from crawler.crawler_services.helper_services.spell_check_handler import spell_checker_handler
from crawler.crawler_shared_directory.request_manager.request_handler import request_handler


class topic_classifier_preprocessor(request_handler):
    ...
    def __clean_data(self, p_text):
        ...
        for m_word in m_word_list:
            ...
            if m_valid_status is True:
                m_stemmed_word = m_word
                m_stemmed_word_list.append(m_stemmed_word)

        return STRINGS.S_EMPTY_SPACE.join(m_stemmed_word_list)
