...
from crawler_instance.local_shared_model.index_model import index_model
...
class parse_controller:
    ...
    def on_parse_files(self, p_parsed_model):
        m_images, m_documents, m_videos, m_content_type = self.__on_static_parser_invoke(p_parsed_model.m_images, p_parsed_model. m_document, p_parsed_model. m_video, p_parsed_model.m_content_type[0], p_parsed_model.m_base_url_model.m_url)
