...
class index_model:
    ...
    def __init__(self, p_base_url_model, p_title = None, p_description = None, p_correct_keyword = None , p_incorrect_keyword = None , p_uniary_tfidf_score = None , p_binary_tfidf_score = None , p_validity_score = None ,p_content_type = None ,  p_sub_url = None , p_images = None , p_documents = None , p_videos = None ):
        self.m_base_url_model = p_base_url_model
        self.m_title = p_title
        self.m_description = p_description
        self.m_correct_keyword = p_correct_keyword
